...
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #00141f, #00080d);
...
st.sidebar.markdown('<div class="pulse-bar"></div>', unsafe_allow_html=True)
